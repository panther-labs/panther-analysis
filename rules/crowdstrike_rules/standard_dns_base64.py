from panther_base_helpers import crowdstrike_detection_alert_context, defang_ioc
import re

def rule(event):
    # Return True to match the log event and trigger an alert.

    # To reduce false positives, dont match against leading subdomains that are only 4 characters in length.
