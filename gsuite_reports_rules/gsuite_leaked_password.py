...
def rule(event):
    ...
    return bool(details_lookup('account_warning', ['account_disabled_password_leak'], event))


def title(event):
    details = details_lookup('account_warning', ['account_disabled_password_leak'], event)
