...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Prepare scenario data from JSONL-formatted files.')
    parser.add_argument('--input',
                        help='the JSONL filename',
                        required=True)
    parser.add_argument('--output',
                        help='the YAML scenario filename',
                        required=True)
    parser.add_argument('--log-type',
                        help='the test scenario log type (e.g. AWS.CloudTrail)',
                        required=True)
